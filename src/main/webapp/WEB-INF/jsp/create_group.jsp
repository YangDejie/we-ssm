...
<div id="container" class="container">
    ...
    <div class="weui-cells__title">创建群组</div>
    <form class="weui-cells weui-cells_form" action="create_group" id="create_group" method="post">
        <div class="weui-cell">
            <div class="weui-cell__hd"><label class="weui-label">群ID</label></div>
            <div class="weui-cell__bd">
                <input class="weui-input" id="GID" name ="GID" type="number" pattern="[0-9]*" placeholder="请输入群 ID">
            </div>
        </div>
        <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" type="text"  id="GName" name ="GName" placeholder="请群名称">
        </div>
        </div>
        <div class="weui-cell">
            <div class="weui-cell__hd">
        ...
        <div class="weui-cell">
            <div class="weui-cell__hd"><label class="weui-label">是否为隐私群</label></div>
            <div class="weui-cell__bd">
                <input class="weui-input" id="isVisible" name ="isVisible" type="number" pattern="[0-9]*" placeholder="0为隐私，其他为公开">
            </div>
        </div>
    </form>

    <c:if test= "${not empty create_group}" >
        <div class="weui-cells__tips" style="color: #04be02;">${create_group} </div>
    </c:if>
    ...
    <input  type="submit" value="确认" form ="create_group" />
    <div class="weui-cells__tips"></div>
